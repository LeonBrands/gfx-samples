...
int main() {
    ...
    std::ifstream vertexFile("../002_vertex_buffer/vertex.spv", std::ios::ate | std::ios::binary);
    ...
    std::ifstream fragmentFile("../002_vertex_buffer/fragment.spv", std::ios::ate | std::ios::binary);
